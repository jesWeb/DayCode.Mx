...
<<<<<<< HEAD
            <div class="services-content mt-5 ">
                <div class="row box-serv mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/base-datos.svg" alt="" class="icono" width="100" height="100">
                        </div>
                        <p>Desarrollo Web </p>
                        <a href="" class="btn btn-primary">Contratar</a>
                    </div>
                    <div class="col-md-9 box-serv-info ">
                        <p>¿Sabe que es la presencia digital? Esta conlleva estar presente por medio de publicidad, o
                            sitio
                            web,
                            en
                            ...
                            página en
                            internet
                            para su negocio o negocios le permitirá tener presencia digital sumado al gran aumente en el
                            alcance
                            al
                ...
                <div class="row box-serv  mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/capacitacion.svg" alt="" class="icono" width="100" height="100">
                        </div>
...
>>>>>>> f241c944b3c1710b1adf54fd501c2a06216e4019
                ...
                <div class="row box-serv  mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/marketing.svg" alt="" class="icono" width="100" height="100">
                        </div>
                        <p>Desarrollo Web </p>
                        <a href="" class="btn btn-primary">Contratar</a>
                    </div>
                ...
                <div class="row box-serv  mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/software.svg" alt="" class="icono" width="100" height="100">
                        </div>
                        <p>Desarrollo Web </p>
                        <a href="" class="btn btn-primary">Contratar</a>
                    </div>
                ...
                <div class="row box-serv  mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/web.svg" alt="" class="icono" width="100" height="100">
                        </div>
                        <p>Desarrollo Web </p>
                        <a href="" class="btn btn-primary">Contratar</a>
                    </div>
                ...
                <div class="row box-serv  mb-3">
                    <div class="col-md-3 box-serv-icon ">
                        <div class="box-serv-icon_img">
                            <img src="<?= base_url?>assets/IMG/serv-icons/cursos.svg" alt="" class="icono" width="100" height="100">
                        </div>
                        <p>Desarrollo Web </p>
                        <a href="" class="btn btn-primary">Contratar</a>
                    </div>
