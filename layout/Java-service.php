        ...
        <section class="">
            ...
            <div class="container">
                <div class="ratio ratio-4x3">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Z8zAKYLZBqc"
            ...
            <div class="container">
                <div class="row mt-4">
                    <div class="col col-sm-4">
                        ...
                        <h4>Java</h4>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda provident accusamus
                            maiores? Iure provident et odio ipsum quis cumque mollitia distinctio voluptatem nam
                            perferendis, iste deleniti molestiae a maiores non?</p>
                    </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        Sección 1: Introduccion a Java Conceptos basicos
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Sección 2: Programacion principiantes
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        Sección 3: Practica Programando
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
